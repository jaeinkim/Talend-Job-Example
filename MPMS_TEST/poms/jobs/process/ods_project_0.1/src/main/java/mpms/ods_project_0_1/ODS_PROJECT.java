...
/**
 * Job: ODS_PROJECT Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class ODS_PROJECT implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "ODS_PROJECT";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ODS_PROJECT.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:rmBmka9T62j0o1RnmKOKZqOKdkvPTA/xKGrRSAXrdm96S8/2");
...
query_tDBRow_1 = "truncate table ODS.projects";
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_MPMS_ODS_PROJECT = new byte[0];
    static byte[] commonByteArray_MPMS_ODS_PROJECT = new byte[0];
	...
	public void copyDataTo(row1Struct other) {
		...
		other.id = this.id;
	            ...
	            other.is_public = this.is_public;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MPMS_ODS_PROJECT.length) {
				if(length < 1024 && commonByteArray_MPMS_ODS_PROJECT.length == 0) {
   					commonByteArray_MPMS_ODS_PROJECT = new byte[1024];
				} else {
   					commonByteArray_MPMS_ODS_PROJECT = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MPMS_ODS_PROJECT, 0, length);
			strReturn = new String(commonByteArray_MPMS_ODS_PROJECT, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MPMS_ODS_PROJECT) {
					...
					this.description = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.is_public = dis.readBoolean();
           				}
					...
					// Boolean
						...
						if(this.is_public == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeBoolean(this.is_public);
		            	}
    ...
    public String toString() {
		...
		sb.append(",is_public="+String.valueOf(is_public));
	    sb.append("]");
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	tableName_tDBOutput_2 = ("projects");
} else {
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("projects");
}
...
String dbUser_tDBOutput_2 = null;
	...
	final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:YTPo/YfffdBY8tVYMV0mRPcOh4keSsIgoSOveDErIMxwts/K");
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"id\",\"name\",\"parent_id\",\"created_on\",\"updated_on\",\"status\",\"rgt\",\"description\",\"is_public\") VALUES (?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:d4fZkAy0Wwj08LBHJr8E64nkZdbWq5gWjrDnqNtlTj5HT+t0woY=");
...
+"	is_public\nfrom BITNAMI_REDMINE.projects";
            ...
            row1.parent_id = rs_tDBInput_2.getInt(3);
            if(rs_tDBInput_2.wasNull()){
                    row1.parent_id = null;
            }
		                    }
				...
				if(rs_tDBInput_2.getString(4) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row1.created_on = rs_tDBInput_2.getTimestamp(4);
					} else {
						row1.created_on = (java.util.Date) year0_tDBInput_2.clone();
					}
				} else {
					row1.created_on =  null;
				}
				...
				if(rs_tDBInput_2.getString(5) != null) {
					...
					if (!("0000-00-00").equals(dateString_tDBInput_2) && !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
						row1.updated_on = rs_tDBInput_2.getTimestamp(5);
					} else {
            ...
            row1.status = rs_tDBInput_2.getInt(6);
            if(rs_tDBInput_2.wasNull()){
                    row1.status = null;
            }
		                    }
            ...
            row1.rgt = rs_tDBInput_2.getInt(7);
            if(rs_tDBInput_2.wasNull()){
                    row1.rgt = null;
            }
		                    }
        	...
        	row1.description = routines.system.JDBCUtil.getString(rs_tDBInput_2, 8, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 9) {
								row1.is_public = null;
							} else {
	                         		
            row1.is_public = rs_tDBInput_2.getBoolean(9);
            if(rs_tDBInput_2.wasNull()){
                    row1.is_public = null;
            }
		                    }
...
} else {pstmt_tDBOutput_2.setInt(3, row1.parent_id);
}

                    if(row1.created_on != null) {
pstmt_tDBOutput_2.setTimestamp(4, new java.sql.Timestamp(row1.created_on.getTime()));
} else {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.TIMESTAMP);
}

                    if(row1.updated_on != null) {
pstmt_tDBOutput_2.setTimestamp(5, new java.sql.Timestamp(row1.updated_on.getTime()));
} else {
...
} else {pstmt_tDBOutput_2.setInt(6, row1.status);
}

                    if(row1.rgt == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_2.setInt(7, row1.rgt);
}

                    if(row1.description == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, row1.description);
}

                    if(row1.is_public == null) {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.BOOLEAN);
} else {pstmt_tDBOutput_2.setBoolean(9, row1.is_public);
}
 ...
 */
    ...
    public static void main(String[] args){
        final ODS_PROJECT ODS_PROJECTClass = new ODS_PROJECT();

        int exitCode = ODS_PROJECTClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ODS_PROJECT.class.getClassLoader().getResourceAsStream("mpms/ods_project_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ODS_PROJECT.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ODS_PROJECT");
        }
...
/************************************************************************************************
 *     57391 characters generated by Talend Open Studio for Data Integration 
 *     on the 2020년 4월 3일 (금) 오전 10시 03분 42초
 ************************************************************************************************/