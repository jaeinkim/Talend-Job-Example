...
package mpms.mart_dim_author_0_1;
...
/**
 * Job: MART_DIM_AUTHOR Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class MART_DIM_AUTHOR implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "MART_DIM_AUTHOR";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MART_DIM_AUTHOR.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MART_DIM_AUTHOR.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBRow_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBRow_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Wa0xecEqRoxJnuNwYV5cAdyGOhSVuCo2jXKYv5JJzXUjwvTK");
...
query_tDBRow_2 = "truncate table red_mart.dim_author";
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_MPMS_MART_DIM_AUTHOR = new byte[0];
    static byte[] commonByteArray_MPMS_MART_DIM_AUTHOR = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MPMS_MART_DIM_AUTHOR.length) {
				if(length < 1024 && commonByteArray_MPMS_MART_DIM_AUTHOR.length == 0) {
   					commonByteArray_MPMS_MART_DIM_AUTHOR = new byte[1024];
				} else {
   					commonByteArray_MPMS_MART_DIM_AUTHOR = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MPMS_MART_DIM_AUTHOR, 0, length);
			strReturn = new String(commonByteArray_MPMS_MART_DIM_AUTHOR, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MPMS_MART_DIM_AUTHOR) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.author_name = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.author_name,dos);
    ...
    public String toString() {
		...
		sb.append(",author_name="+author_name);
	    sb.append("]");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("dim_author");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("dim_author");
}
...
String dbUser_tDBOutput_1 = null;
	...
	final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:PX0ukLk870vQ+FDqVZZkul0Lb7KygcoB+n/Yki22S6BqnDFm");
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"author_id\",\"author_name\") VALUES (?,?)";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:twE/TCE6mV8UAxiB7JL6r7wE87Er/l8YrSFUkScsQ2NAAJwx");
		    ...
		    String dbquery_tDBInput_1 = "select id as author_id, \nname as author_name\nfrom ods.users\nwhere name <> ''\ngroup by id, name";
            ...
            row1.author_id = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.author_name = null;
							} else {
	                         		
        	row1.author_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    pstmt_tDBOutput_1.setInt(1, row1.author_id);

                    if(row1.author_name == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, row1.author_name);
}
 ...
 */
    ...
    public static void main(String[] args){
        final MART_DIM_AUTHOR MART_DIM_AUTHORClass = new MART_DIM_AUTHOR();

        int exitCode = MART_DIM_AUTHORClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MART_DIM_AUTHOR.class.getClassLoader().getResourceAsStream("mpms/mart_dim_author_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MART_DIM_AUTHOR.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MART_DIM_AUTHOR");
        }
...
/************************************************************************************************
 *     48660 characters generated by Talend Open Studio for Data Integration 
 *     on the 2020년 4월 3일 (금) 오전 10시 02분 31초
 ************************************************************************************************/